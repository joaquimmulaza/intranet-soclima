...
<a class="view_justificativos">
    ...
    <table class="docs_table docs_tableDocRecebidos">          
        <thead>
            <tr>
                <th></th>
                <th >Tipo</th>
                <th class="th_justificativos">Enviado por</th>
                <th>Data</th>
                <th ></th>
            </tr>
        </thead>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="td_user_name_justificativos" style="width: 34% !important;">
                    ...
                    <br>
                    <span style="font-weight: 400; font-size: 13px;"> {{ $document->description }}</span>
                    </div>
                </td>
                <td class="data_documents">{{ $document->user->name ?? 'Usuário desconhecido' }}</td>
                <td class="data_documents">{{ $document->created_at->format('d/m/Y') }}</td>
                <td class="OptDocs">
                    
                    <div class="containerOpt">
                        <!-- class .btnOpt removida -->
                        <button class=" more_opt btn-popup"  data-toggle="modal" data-target="#modalOptPhone-{{$document->id }}" style="margin: 0 !important; padding: 0 !important;">
                            <img src="{{asset('logo/img/icon/more_opt.svg')}}" alt="">
                        </button>
                        <div class="modal fade modalOpt modalOpt_justificativos" id="modalOptPhone-{{$document->id}}" tabindex="-1" aria-labelledby="modalOptLabel" aria-hidden="true" data-backdrop="true" data-keyboard="true">
                                ...
                                <div class="modal-content">
                                    <div class="modal-body modal-bodyOpt">
                                        ...
                                        <form action="" method="POST" class="">
                                            ...
                                            <a href="{{ asset('storage/' . $document->file_path) }}" class="" target="_blank">Download</a>
                                            </button>
                                        </form>
                                       
                                            <button style="border-bottom-right-radius: 5px;    border-bottom-left-radius: 5px;" type="button" class=" btnPosts btnPostsDelete "  data-id="{{$document->id}}">
                                                Eliminar
                                            </button>
                                            <form id=""
                                        ...
                                        <button style="border-radius: 5px;" type="button" class="hidden btnPosts btnPostsDelete "  data-id="">
                                                Apagar da lista
                                            </button>
                                            <form id="delete-form-"
                                                    action="" method="POST" style="display: none;" class="btn-popup hidden">
                                                @csrf()
                                                @method('DELETE')
                                            </form>
    ...
    <div class="text-center containerEmptyPage">
        ...
        <h1 class="titleEmptyPage">Nenhum documento recebido</h1>
        <p class="sentenceEmptyPage">Quando um documento for enviado, poderá gerenciá-lo aqui.</p>
    </div>
@endforelse
